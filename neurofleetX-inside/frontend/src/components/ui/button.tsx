  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold uppercase tracking-wider transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        neon: "bg-gradient-to-r from-primary to-accent text-primary-foreground shadow-[0_0_20px_hsl(var(--primary)/0.3)] hover:shadow-[0_0_40px_hsl(var(--primary)/0.5)] hover:-translate-y-1",
        success: "bg-success text-success-foreground shadow-[0_0_20px_hsl(var(--success)/0.3)] hover:bg-success/90",
        warning: "bg-warning text-warning-foreground shadow-[0_0_20px_hsl(var(--warning)/0.3)] hover:bg-warning/90",
      },
      size: {
